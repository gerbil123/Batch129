...
public class C02_Lists {
    ...
    public static void main(String[] args) {
        ...
        if (databaseIsim.contains(username)){
            int rastgeleSayı = new Random().nextInt(100);
            username = username + "" + rastgeleSayı;
            System.out.println("Yeni kullanıcı adı olarak bunu kullanabilirsiniz" + username);

        }else
            System.out.println("Bu kullanıcı adını kullanabilirsin");
