...
public class MiladıTakvim {
    /*
    yerel tarih ve zamana gore; gecerli tarih ve saat
    diliminde bir Miladi Takvim olustur.Mevcut yılın isLeapYear olup olmadıgını gösteriniz.
    */
    ...
    public static void main(String[] args) {
        ...
        if (miladiTakvim.isLeapYear(year)){
            ...
            System.out.println("Bu yıl artık yıl değil ");
