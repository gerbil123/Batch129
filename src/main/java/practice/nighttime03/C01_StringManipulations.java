 ...
 */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ikiyuzkırk" + 40 * 6); //çarpmada işlem önceliği vardır ikiyuzkırk240
        System.out.println(60 + 40 + "Yuz"); //100Yuz

        //Kullanıcıdan ismini soyismini alınız. Kullanıcı nasıl girerse girsin tam isminin buyuk harfle yazılmasını sağlayın
        Scanner input = new Scanner(System.in);
        System.out.println("Lütfen isminizi soyadınızı giriniz.");
        ...
        String str2 = "Learn Java earn 90000000 money,!... ";
        System.out.println(str2.replaceAll("\\W","").replaceAll("\\d","").length());
