...
public class C01_Varags {
 ...
 7)Bir metotta birden fazla "Varargs" parametresi kullanabilir miyim?
    ...
    public static void main(String[] args) {
        ...
        //Varargs kullanarak verilen String dataları birleştiren code'u yazınız.
    ...
    private static void concat(String ... mürsel) {//mürsel yazmamızın sebebi istediğimizi yazabiliyoruz.
        String sonuc = "";
        for (String w : mürsel) {
                sonuc+=w + " ";
        }
