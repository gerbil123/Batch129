...
public class Exceptions02 {
    ...
    public static void m(int[] c, int a, int b){
        ...
        }catch (Exception e){//bunu yazarsak butun exception'ların yapacağı işi yapar.Spesifik exception kullanmka istemiyosanız
            System.out.println(e.getMessage()); //parent olan exception kullanabilirsiniz.
        }
    }
}
